        ...
        https.get(url, response => {
            ...
            response.on('end', async () => {
                ...
                if (targetSeasonIsNew) {
                    ...
                    await insertWebSchedule(url, html, dayjs().utc().valueOf(), targetSeason, targetSeasonWasProcessed);
                }
                else {
                    console.log('updating');
                    await updateWebSchedule(webScheduleId, html, dayjs().utc().valueOf(), targetSeasonWasProcessed);
                }
            });
        });
    })();
